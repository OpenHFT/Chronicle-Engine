...
|entrySet<key>  | chunked - when server buffer full  |https://github.com/OpenHFT/Chronicle-Engine/blob/master/docs/entrySet-buffer-full.md      |
|entrySet<key>  | all data single messsage  |https://github.com/OpenHFT/Chronicle-Engine/blob/master/docs/entrySet.md      |
