...
public class CharCharMapHandler implements MapHandler {
    ...
    private final Function<ValueIn, CharSequence> wireToKey = ValueIn::text;
    ...
    private final Function<ValueIn, Map.Entry<CharSequence, CharSequence>> wireToEntry
        ...
        final CharSequence key = x.read(() -> "key").object(keySB,StringBuilder.class);
        final CharSequence value = x.read(() -> "value").object(valueSB,StringBuilder.class);
