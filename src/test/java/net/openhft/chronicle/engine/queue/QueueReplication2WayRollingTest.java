...
public class QueueReplication2WayRollingTest {

    private final WireType wireType;
    private ChronicleQueue queue1;
    private ChronicleQueue queue2;
    ...
    public QueueReplication2WayRollingTest(WireType wireType) {
    ...
    public void before() throws IOException, InterruptedException {
        ...
        queue1 = new SingleChronicleQueueBuilder(Files.createTempDirectory
                ("chronicle" + "-").toFile())
        ...
        queue2 = new SingleChronicleQueueBuilder(Files.createTempDirectory
                ("chronicle" + "-").toFile())
                //   .wireType(this.wireType)
                .timeProvider(stp)
                .indexSpacing(1).indexCount(8)
...

        {
            ...
            asset.addView(QueueView.class, new ChronicleQueueView(queue2, context, asset));
        }
